...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FactoryState.factoryId'
        db.add_column('factoryState_factorystate', 'factoryId',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FactoryState.factoryId'
        db.delete_column('factoryState_factorystate', 'factoryId')
