...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FactoryState.halfAdvance'
        db.add_column('factoryState_factorystate', 'halfAdvance',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FactoryState.halfAdvance'
        db.delete_column('factoryState_factorystate', 'halfAdvance')
