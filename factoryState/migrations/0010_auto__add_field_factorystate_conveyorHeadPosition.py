...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FactoryState.conveyorHeadPosition'
        db.add_column('factoryState_factorystate', 'conveyorHeadPosition',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FactoryState.conveyorHeadPosition'
        db.delete_column('factoryState_factorystate', 'conveyorHeadPosition')
    ...
    models = {
        'factoryState.factorystate': {
            ...
            'conveyorHeadPosition': ('django.db.models.fields.FloatField', [], {}),
