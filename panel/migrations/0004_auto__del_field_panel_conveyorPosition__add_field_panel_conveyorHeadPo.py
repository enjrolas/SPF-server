...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Panel.conveyorPosition'
        db.delete_column('panel_panel', 'conveyorPosition')
    ...
    def backwards(self, orm):
        # Adding field 'Panel.conveyorPosition'
        db.add_column('panel_panel', 'conveyorPosition',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
